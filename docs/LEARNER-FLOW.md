...
|---|---|---|
| 教材サイト | 動画、公式資料、Quiz、Task確認 | 閲覧権限とLinkを案内する |
...
- 教材サイトの受講者Allowlistを登録する
- GitHub OrganizationまたはPrivate Repositoryへ受講者を招待する
- 受講者ごとのRepository作成方法を案内する
- 講師が閲覧できるPR提出先を決める

Publicと招待制を混在させません。教材サイトへ入れてもGitHubへ入れない、またはその逆になる状態を開始前に検査します。
